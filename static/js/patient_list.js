        ...
        <tr class="table-row" data-patient='${JSON.stringify(patient)}'>
            ...
            <td>
                <div class="report-info">
                    <span><i>📄</i>${patient.reports && patient.reports.length ? patient.reports.map(r => r.tests).join(', ') : 'None'}</span>
                </div>
            </td>
        </tr>
    `;
                ...
                <tbody>
                    ${filteredPatients.map(patient => `
                        <tr>
                            ...
                            <td>${formatDate(patient.lastVisit)}</td>
                            <td>${patient.reports ? (Array.isArray(patient.reports) ? patient.reports.map(r => r.reports || r).join(', ') : patient.reports) : 'None'}</td>
                        </tr>
                    `).join('')}
                </tbody>
            </table>
